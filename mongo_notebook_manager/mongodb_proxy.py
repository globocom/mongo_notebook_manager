"""
copied from http://www.arngarden.com/2013/04/29/handling-mongodb-autoreconnect-exceptions-in-python-using-a-proxy/
as it is currently not available as a module
"""
import time
import pymongo
